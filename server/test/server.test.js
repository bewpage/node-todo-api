...
describe('DELETE /todos/:id', () => {
   it('should remove a todo', (done) => {
       ...
       request(app)
           ...
           //query databas using findById and toNotExist
               //*******here is a problem with expect new version
               //*******temp solution with toEqual()
...
describe('PATCH /todos/:id', () => {
    it('should update the todo', (done) => {
        const hexId = todos[0]._id.toHexString();
        const text = 'some extra text for first patch test';
    ...
    it('should clear completedAt when todo in not completed', (done) => {
        const hexId = todos[1]._id.toHexString();
        const text = 'some extra text for second patch test';
